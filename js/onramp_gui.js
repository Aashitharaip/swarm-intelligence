...
function spawnAmbulance() {
    if (!mainroad) {
        console.error("Main road not initialized!");
        return;
    }

    var ambulancLength = 10;
    var ambulanceWidth = 5;
    var speed = 30;
    var lane = 0;
    var uDistance = 0
    const ambulance = new vehicle(ambulancLength, ambulanceWidth, uDistance, lane, speed, "ambulance");
    mainroad.veh.push(ambulance)
}
